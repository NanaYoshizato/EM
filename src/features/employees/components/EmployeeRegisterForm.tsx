...
export default function EmployeeRegisterForm() {
  const { form, onSubmit, error } = useEmployeeRegister();
        ...
        <Stack gap="xl">
          ...
          <Stack gap="xs">
            ...
            <Stack gap="sm" pt="xs">
              ...
              <FormRow label="電話番号">
                <TextInput placeholder="090-0000-0000" style={{ width: 240 }} {...form.getInputProps("phone")} />
              </FormRow>
          ...
          <Group justify="center" gap="md" pt="md">
            <Button variant="default" onClick={() => router.push("/employees")}>
              キャンセル
            </Button>
